package com.vali.net.http.common.util;
...
import com.vali.net.HttpClientUtil;
import com.vali.net.http.builder.HCB;
import com.vali.net.http.common.HttpConfig;
import com.vali.net.http.common.HttpHeader;
import com.vali.net.http.common.Utils;
import com.vali.net.http.exception.HttpProcessException;
import java.io.*;
