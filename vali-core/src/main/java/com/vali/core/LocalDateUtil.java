...
public class LocalDateUtil {
    ...
    public static Date convertToDate(LocalDateTime localDateTime) {
        ...
        Instant instant = localDateTime.atZone(zoneId)
                .toInstant();
    ...
    public static String getWeekday(LocalDate localDate) {
        int week = localDate.get(WeekFields.of(DayOfWeek.of(1), 1)
                .dayOfWeek());
        switch (week) {
        case 1:
            return "星期一";
    ...
    public static Date getFirstDayOfWeek(Date date) {
        ...
        TemporalField temporalField = WeekFields.of(Locale.CHINA)
                .dayOfWeek();
