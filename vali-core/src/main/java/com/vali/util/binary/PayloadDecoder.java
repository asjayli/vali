...
public class PayloadDecoder {
    ...
    private static void fillData(FieldWrapper fieldWrapper, Object instance, ByteBuf buffer) {
        ...
        try {
            ...
            case "char":
                CharSequence charSequence = buffer.readCharSequence(fieldWrapper.getCodecProprety()
            ...
            case "java.lang.String":
                String readString = buffer.readCharSequence(fieldWrapper.getCodecProprety()
                        .length(), Charset.forName("UTF-8"))
                        .toString();
