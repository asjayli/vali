...
import com.kitsrc.watt.net.auth.ECSMetadataServiceCredentialsFetcher;
import com.kitsrc.watt.net.auth.InstanceProfileCredentials;
import com.kitsrc.watt.net.auth.InstanceProfileCredentialsProvider;
...
public class InstanceProfileCredentialsProviderTest {
    ...
    public void getCredentialsPreviousNull() throws ClientException {
        ...
        provider.withFetcher(fetcher);
        Credentials credentialsRes = provider.getCredentials();
    ...
    public void getCredentialsPreviousExpired() throws ClientException {
        ...
        Credentials credentialsRes1 = provider.getCredentials();
