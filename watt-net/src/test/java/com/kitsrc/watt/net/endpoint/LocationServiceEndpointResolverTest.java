...
import com.kitsrc.watt.net.endpoint.LocationServiceEndpointResolver;
import com.kitsrc.watt.net.endpoint.ResolveEndpointRequest;
import com.kitsrc.watt.net.endpoint.location.model.v20150612.DescribeEndpointsRequest;
...
public class LocationServiceEndpointResolverTest {
    ...
    public void setLocationServiceEndpointTest() {
        ...
        assertEquals("test", resolver.getLocationServiceEndpoint());
    }
