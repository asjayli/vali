...
import com.kitsrc.watt.net.auth.HmacSHA1Signer;
import com.kitsrc.watt.net.auth.Signer;
...
public class RpcDubboApiRequest extends RpcAcsRequest<RpcDubboApiResponse> {
    ...
    @Override
    public HttpRequest signRequest(Signer signer, Credentials credentials, FormatType format, ProductDomain domain)
