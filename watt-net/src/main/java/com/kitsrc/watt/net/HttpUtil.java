...
import com.kitsrc.watt.net.Response;
import com.kitsrc.watt.net.constant.*;
import com.kitsrc.watt.utils.MessageDigestUtil;
...
public class HttpUtil {
    ...
    throws MalformedURLException {
        ...
        headers.put(SystemHeader.X_CA_SIGNATURE,
                    com.aliyun.api.gateway.demo.util.SignUtil.sign(appSecret, method, path, headers, querys, bodys,
    ...
    private static Response convert(HttpResponse response) throws IOException {
        ...
        if (null != response) {
            res.setStatusCode(response.getStatusLine()
                                      .getStatusCode());
            ...
            res.setBody(readStreamAsStr(response.getEntity()
                                                .getContent()));
