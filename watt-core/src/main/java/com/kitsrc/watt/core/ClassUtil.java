...
public class ClassUtil {
    ...
    /**
     * Maps names of primitives to their corresponding primitive {@code Class}es. PRIMITIVE_TYPE_NAME_MAP
     */
     ...
     */
    public static Class<?> forName2(String name, ClassLoader classLoader)
    throws ClassNotFoundException, LinkageError {
        ...
        if (name.startsWith(NON_PRIMITIVE_ARRAY_PREFIX) && name.endsWith(StringPool.SEMICOLON)) {
...
//		}
    ...
    public static Class<?> getPrimitiveBoxClass(String primitiveClassName) {
        return ClassUtil.PRIMITIVE_TYPE_NAME_MAP.get(primitiveClassName);
    }
    ...
    public static String addResourcePathToPackagePath(Class<?> clazz, String resourceName) {
        ...
        if (!resourceName.startsWith(StringPool.SLASH)) {
    ...
    public static Class<?> getUserClass(Class<?> clazz) {
        if (clazz.getName()
                 .contains(CGLIB_CLASS_SEPARATOR)) {
    ...
    public static String getShortName(String className) {
        Assert.notBlank(className, "Class name must not be empty");
    ...
    public static Method getInterfaceMethodIfPossible(Method method) {
        if (Modifier.isPublic(method.getModifiers()) && !method.getDeclaringClass()
                                                               .isInterface()) {
    ...
    private static boolean isGroovyObjectMethod(Method method) {
        return "groovy.lang.GroovyObject".equals(method.getDeclaringClass()
                                                       .getName());
    }
